...
ggplot(climate_model_aug, mapping = aes(x = .fitted, y = .std.resid)) +
  ...
  labs(x = "Value", y = "Residuals", title = "Graph 11: Residuals have 
  realatively equal variance when plotted with the line y = 0")
```
...
ggplot(data = climate_model_aug, 
  ...
  do not form any patterns or clusters, making them independent")
```
