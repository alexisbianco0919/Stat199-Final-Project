...
$H_0$: There is no relationship between carbon emissions per capita and the log proportion of refugees. The coefficient in the linear model with log transformation is 0.

$H_1$: There is a relationship between carbon emission per capita and the log proportion of refugees. The coefficient in the linear model with log transformation is not 0.
