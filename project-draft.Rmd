...
In order to analyze our data, we will construct a multiple linear regression model with percentage of land that is arable, amount of land under cereal production, methane emissions, nitrous emissions, and CO2 emissions (all measured in kilotons per capita) and refugees as percentage of overall population as the response variable.  The model was constructed using data from Afghanistan, Iraq, Iran, and Pakistan. Constructing this model will allow us to see which predictors have the most significant impact on refugee flow from a country. The model used a log transformation of the refugee proportion.
