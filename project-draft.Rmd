...
climate <- climate %>%
  ...
  select(`Time`, `Country Name`, arable_land, land_cereal, co2_tons, nitrous_tons, methane_tons, refugee, pop, prop_refugee, refugee_per_100000)
...
```{r linear-regression-interactions, eval=FALSE}
