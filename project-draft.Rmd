...
Our fitted main-effects linear regression model with a logarithmic transformation, where each predictor corresponds to the predicted logit of the proportion of refugees in a population, is as follows: 
...
We also tried to use a log transform linear model with interactions between each of the predictor variables, but we found that this model had limited usefulness compared to the model with just main interactions.
