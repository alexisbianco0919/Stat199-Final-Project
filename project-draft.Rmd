...
#Save into new file; repeat process; rename the variables to be the same so that r-bind can occur
...
climate_model <- lm(refugee_10 ~ population_density_10 + fossil_fuel_10 + CO2_emissions_10 + cereal_production_10, data = climate_pakistan)
tidy(climate_model)
