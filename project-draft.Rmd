---
title: "Climate Change and Refugee Flow"
...
ggplot(data = predicted_iran) +
  ...
  labs(x = "Year", y = "Proportion of refugees in Iran",
       ...
       to observed proportion aside from 2 major outliers", subtitle = 
...
ggplot(data = predicted_afghan) +
  ...
  labs(x = "Year", y = "Proportion of refugees in Afghanistan",
       ...
       observed proportion until 1995", subtitle = 
         "Red points are predicted values and black points are observed values")
...
ggplot(data = predicted_iraq) +
  ...
  labs(x = "Year", y = "Proportion of refugees in Iraq",
       ...
       to observed proportion aside from 1 major outliers", subtitle = 
         "Red points are predicted values and black points are observed values")
```
...
To further evaluate our model, we applied it to another at risk region as identified by the Ecological Threat Register, the Sahel Belt of Africa. The Sahel Belt includes Senegal, Mauritania, Mali, Burkina Faso, Niger, Chad, Sudan, Eritrea. These countries have similar conflict levels and similar economic situations thus lending it to another application of our model. For visualization we chose to examine a graph of predicted values in Burkina Faso. It was a randomly selected country within the Sahel Belt region.
