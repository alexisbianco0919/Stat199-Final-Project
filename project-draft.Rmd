...
ggplot(data = climate_refugee, mapping = aes(x = `Time`,
  ...
  geom_line() +
  labs(x = "Year", 
       y = "Refugees as Proportion of Population in Country of Origin", 
       title = "Graph 1: The proportion of total population that were reguees 
in Iran and Pakistan remained relatively similar, but increased sharply in 
Syria after 2011 civil war")
